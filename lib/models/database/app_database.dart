...
class AppDatabase {
  ...
  Future<void> _onOpen(Database db) async {
    ...
    await _seedCategoryTemplates(db);
  }
  ...
  Future<void> _seedCategoryTemplates(Database db) async {
    try {
      final tables = await db.rawQuery(
      ...
      debugPrint('⚠️ Error en _seedCategoryTemplates: $e');
    }
  }
